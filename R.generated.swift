...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `icons8-settings`.
    static let icons8Settings = Rswift.ImageResource(bundle: R.hostingBundle, name: "icons8-settings")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "icons8-settings", bundle: ..., traitCollection: ...)`
    static func icons8Settings(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.icons8Settings, compatibleWith: traitCollection)
    }
    #endif
